...
class Dust extends good
{
    ...
    function getPrise()
    {
        echo "Вы заказали " . $this->getGoodAmount() . " кг. " . $this->getGoodTitle() . " на общую сумму " . ($this->getGoodPrice() - $this->getGoodDiscount()) * $this->getGoodAmount() . " рублей.<hr><hr>";
    }
